        ...
        <View style={styles.flexRowWrap}>
            { 
                data && data.map((item, index) => {
                    ...
                    let backgroundColor = isActive ? theme.colors.neautral(0.7) : 'white';
                    let color = isActive ? 'white' : theme.colors.neautral(0.7);
    ...
    return (
        <View style={styles.flexRowWrap}>
            { 
                data && data.map((item, index) => {
                    let isActive = filters && filters[filterName] == item;
                    let borderColor = isActive ? theme.colors.neautral(0.7) : 'white';
...
const styles = StyleSheet.create({
    ...
    sectionTitle: {
        ...
        color: theme.colors.neautral(0.8),
    },
    flexRowWrap: {
        gap: 10,
        flexDirection: 'row',
