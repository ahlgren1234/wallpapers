                ...
                <View style={styles.content}>
                    ...
                    >
                        <Pressable
                            ...
                            onPress={onReset}
                        >
                            <Text style={[styles.ButtonText, {color: theme.colors.neautral(0.9)}]}>Reset</Text>
                        </Pressable>
                        <Pressable
...
const styles = StyleSheet.create({
    ...
    applyButton: {
        flex: 1,
        backgroundColor: theme.colors.neautral(0.8),
        padding: 12,
        alignItems: 'center',
    ...
    resetButton: {
        flex: 1,
        backgroundColor: theme.colors.neautral(0.03),
        padding: 12,
        alignItems: 'center',
        justifyContent: 'center',
        borderRadius: theme.radius.md,
